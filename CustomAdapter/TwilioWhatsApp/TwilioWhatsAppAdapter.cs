...
namespace TwilioWhatsAppBot.CustomAdapter.TwilioWhatsApp
{
    ...
    /// </summary>
    public class TwilioWhatsAppAdapter : BotAdapter, IBotFrameworkHttpAdapter
    {
        ...
        public TwilioWhatsAppAdapter(IConfiguration configuration, TwilioAdapterOptions adapterOptions = null, ILogger logger = null)
            : this(
        ...
        /// <param name="adapterOptions">Options for the <see cref="TwilioAdapter"/>.</param>
        /// <param name="logger">The ILogger implementation this adapter should use.</param>
        public TwilioWhatsAppAdapter(TwilioClientWrapper twilioClient, TwilioAdapterOptions adapterOptions, ILogger logger = null)
        {
